...
function App() {
  ...
  return (
    <>
      <AppRouter />
      {/*}
      <div className="page-sidebar-collapsed">
          ...
          <div class="page-sidebar">
            ...
            <ul class="list-unstyled accordion-menu">
              <li class="active-page">
                <a href="#" class="active"
                ><i data-feather="activity"></i>Dashboard<i
                  class="fas fa-chevron-right dropdown-icon"
                ></i></a>
                <ul class="">
                  <li>
                    <a href="index.html" class="active"
                    ><i class="far fa-circle"></i>eCommerce</a
                    >
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul class="">
                  ...
                  <li>
                    ...
                    ><i class="far fa-circle"></i>Calendar</a
                    >
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    ><i class="far fa-circle"></i>File Manager</a
                    >
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul class="">
                  ...
                  <li>
                    ...
                    ><i class="far fa-circle"></i>Popovers</a
                    >
                  </li>
                  <li>
                    <a href="progress.html"
                    ><i class="far fa-circle"></i>Progress</a
                    >
                  </li>
                  <li>
                    <a href="spinners.html"
                    ><i class="far fa-circle"></i>Spinners</a
                    >
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul class="">
                  <li>
                    ...
                    ><i class="far fa-circle"></i>Block UI</a
                    >
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul class="">
                  ...
                  <li>
                    ...
                    ><i class="far fa-circle"></i>Register</a
                    >
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul class="">
                  ...
                  <li>
                    ...
                    ><i class="far fa-circle"></i>Select2</a
                    >
                  </li>
                </ul>
              </li>
                      ...
                      <div class="card stats-card">
                        <div class="card-body">
                          <div class="stats-info">
                            <h5 class="card-title">
                              $30K<span class="stats-change stats-change-danger"
                              >-8%</span
                              >
                            </h5>
                    ...
                    <div class="col-lg-6">
                      <div class="card stats-card">
                        <div class="card-body">
                          <div class="stats-info">
                            <h5 class="card-title">
                              $21K<span class="stats-change stats-change-danger"
                              >-8%</span
                              >
                            </h5>
                            <p class="stats-text">Total revenue</p>
                    ...
                    <div class="col-lg-6">
                      <div class="card stats-card">
                        <div class="card-body">
                          <div class="stats-info">
                            <h5 class="card-title">
                              1681<span class="stats-change stats-change-success"
                              >+16%</span
                              >
                            </h5>
                    ...
                    <div class="col-lg-6">
                      <div class="card stats-card">
                        <div class="card-body">
                          <div class="stats-info">
                            <h5 class="card-title">
                              4743<span class="stats-change stats-change-success"
                              >+12%</span
                              >
                            </h5>
          ...
          <div class="activity-body">
            <ul class="activity-list list-unstyled">
              ...
              <li class="activity-item activity-danger">
                ...
                <div class="activity-text">
                  Cant retrieve data from server
              ...
              <li class="activity-item">
                ...
                <div class="activity-text">
                  ...
                  <div class="mail-attachment-files">
                    <div class="card">
                      <img
                        src="http://polygons.space/neo/theme/assets/images/card2.jpeg"
                        class="card-img-top"
                        alt="..."
                      />
                      <div class="card-body">
                    ...
                    <div class="card">
                      <img
                        src="http://polygons.space/neo/theme/assets/images/card1.jpeg"
                        class="card-img-top"
                        alt="..."
                      />
                      <div class="card-body">
